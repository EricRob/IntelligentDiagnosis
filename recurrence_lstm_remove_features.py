...
import reader_remove_features as reader_features
import util
...
flags.DEFINE_integer('remove_feature', None, 'Feature to remove from data processing')
...
class ColorConfig(object):
  ...
  test_mode = 0
  num_features = 7
  remove_feature = FLAGS.remove_feature
